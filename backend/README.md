...
5. **Build e execução local:**

   Para ambiente de produção, rode o build:
   ```sh
   npm run bulder
   npm run start
   ```
...
- `DELETE /projects/:id/members/:userId` - Remover membro do projeto - Só o proprietário do projeto tem essa ação habilitada
